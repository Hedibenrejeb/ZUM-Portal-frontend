...
export class UpdatetaskComponent implements OnInit {
  ...
  constructor(private updateservice: TaskService,private projTask:ProjectService , private route: ActivatedRoute, private router: Router, private authenticationService: AuthenticationService, private datePipe: DatePipe) {
  ...
  fixingCode(updatenewTaskForm: Task) {
    ...
    this.updateTask['startdate'] = updatenewTaskForm['startdate'];
  ...
  public getProjects(): void {
    this.projTask.listProject().subscribe(
      (response: any[]) => {
